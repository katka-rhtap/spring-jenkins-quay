...
export IMAGE_URL=${IMAGE_URL-quay.io/tsscui/spring-jenkins-quay:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/katka-rhtap/spring-jenkins-quay-gitops
